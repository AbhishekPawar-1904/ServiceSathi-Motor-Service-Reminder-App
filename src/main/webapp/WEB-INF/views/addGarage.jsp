...
<head>
    ...
    <title>Add Garage | ServiceSathi</title>
...
<body>
    ...
    <div class="form-wrapper">
        <div class="form-header">
            <i class="fas fa-tools"></i> Add New Garage
        </div>

        <form action="SubmitAddGarage" method="post">
            ...
            <button type="submit" class="submit-btn">Add Garage</button>
        </form>
    </div>
