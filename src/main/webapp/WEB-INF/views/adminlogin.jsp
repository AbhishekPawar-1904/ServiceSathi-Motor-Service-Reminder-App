...
<title>Admin Login | ServiceSathi</title>
<link rel="stylesheet"
...
<body>
	<div class="login-container">
		<div class="logo-header">
			<div class="logo">
				<i class="fas fa-user-shield"></i> <span>ServiceSathi</span>
			</div>
			<div class="tagline">Administrator Access Portal</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
						<i class="fas fa-envelope"></i> <input type="email" id="email"
							...
							placeholder="admin@servicesathi.com" required>
					</div>
				</div>
